...
export const WorldClockCatalog = new Array<Entity>({
    ...
    implementation: {
      ...
      source: {
          ...
          <div class="grid">
            <!--div>
              <a class="location" target="_blank" rel="nofollow"
                  href="https://time.is/">Time.is:</a>
              <div>
                <div class=time>&nbsp;</div>
                <div class=sun style="font-size: 1em; line-height: 2em;">
                  <span class=sunrise>Sunrise</span>/<span class=sunset>Sunset</span>:
                </div>
              </div>
            </div-->
            ...
            <div class="clock">
              <a class="location" target="_blank" rel="nofollow"
                  href="https://time.is/Landisville,_New_Jersey">Landisville</a>
              <div id="Landisville__New_Jersey_z161"></div>
            </div>
        ...
        inlineScript: stripIndent(html)`
          const commonConfig = {
            template: "<div class=time>TIME</div><div class=sun>SUN</div>",
            time_format: "hours:minutes",
            sun_format: "<span class=sunrise>srhour:srminute</span><span class=divider>/</span><span class=sunset>sshour:ssminute</span>",
          };
          globalThis.time_is_widget.init({
            ...
            Landisville__New_Jersey_z161: {
              ...commonConfig,
              coords: "39.5248400,-74.9382300",
            },
